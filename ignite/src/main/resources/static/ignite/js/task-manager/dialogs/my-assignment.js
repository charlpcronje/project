...
function saveOfficeContactPoint() {
	...
	var postData = {
		...
		startDate: getMsFromDatePicker("eCPStartDate"),
...
//		hier kort iets		
	...
	if ((postData.contactPointName != "") || (postData.startDate != null) || (postData.emailAddress != "") || (postData.phoneNumber != "")) {
...
//		updateResourceListToolbarButtons();
	...
	resourceListTable.on('select', function (e, dt, type, indexes) {
