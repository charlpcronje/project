...
function initializeNavTabs() {
	$('.nav-tabs a').on('show.bs.tab', function(event) {
		...
		if (activeTab == "Per Industry") {
			currentTab = "Per Industry";
		}

		if (activeTab == "Per Service Discipline") {
			currentTab = "Per Service Discipline";
			//initializeTfsPerSdTree();
		}
...
function setAdditionalTabStates(enabled) {
	...
	setDivVisibility("tfsGeneralTabLink", enabled? "block":"none");
	setDivVisibility("tfsPerSdTabLink",  enabled? "block":"none");
...
$(document).ready(function() {
	...
	console.log("initializeTfsGeneralTree() before");
	initializeTfsGeneralTree();
	console.log("initializeTfsGeneralTree() after");
	initializeNavTabs();
