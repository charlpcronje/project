...
@Entity
@Table(schema = "ig_db", name = "vProjectTimeCost")
public class VProjectTimeCost implements Serializable {

	private static final long serialVersionUID = -715353440870332641L;
