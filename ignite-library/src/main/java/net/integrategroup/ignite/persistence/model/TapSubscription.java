...
@Entity
@Table(schema = "ig_db", name = "TapSubscription")
public class TapSubscription implements Serializable {

	private static final long serialVersionUID = 4574913032413311807L;
