...
@Entity
@Table(schema="ig_db", name="TaxDeductableCategory")
public class TaxDeductableCategory implements Serializable {

	private static final long serialVersionUID = -2627706434223218326L;
