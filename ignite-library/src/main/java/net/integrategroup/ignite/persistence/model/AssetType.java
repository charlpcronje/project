...
/** ******* ********* ** 2023-10-26 19:46:16 ******** *xxx* **/

@Entity
@Table(schema = "ig_db", name = "AssetType")
public class AssetType implements Serializable {


    private static final long serialVersionUID = 851375003190097722L; /** ID was Generated by Johannes **/
...
/**  javascript      vir grid population        (jsStr)
	...
	var columnsArray = [
		 { data: "assetTypeId" }              //0 MySql-TableName: AssetType
		,{ data: "name" }                     //1
		,{ data: "description" }              //2
...
/**  javascript      vir grid SelectFromGridDialog        (js1Str)
	...
	var columns = [
		{ data: "assetTypeId", name: "AssetTypeId" }                       //0 MySql-TableName: AssetType
...
Vir 'n Save Data function                        (js2Str)
	...
	var postData = {
		assetTypeId : $("#xxxAssetTypeId").val()              //0 MySql-TableName: AssetType
		,name : $("#xxxName").val()                                                  //1
...
Vir 'n Populate Data function                                                  (js3Str)
		...
		//  MySql-TableName: AssetType										   (js3Str)
		$("#xxxAssetTypeId").val(data.assetTypeId);                       //0
...
/**  HTML  om 'n grid te populate
												<th>AssetTypeId</th>                 <!--0  MySql-TableName: AssetType-->
												<th>Name</th>                        <!--1  Name-->
