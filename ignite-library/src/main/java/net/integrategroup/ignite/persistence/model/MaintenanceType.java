...
/** ******* ********* ** 2023-10-25 18:51:56 ******** *xxx* **/

@Entity
@Table(schema = "ig_db", name = "MaintenanceType")
public class MaintenanceType implements Serializable {


    private static final long serialVersionUID = 721346240805130758L; /** ID was Generated by Johannes **/
...
/**  javascript      vir grid population        (jsStr)
	...
	var columnsArray = [
		 { data: "maintenanceTypeId" }        //0 MySql-TableName: MaintenanceType
		,{ data: "name" }                     //1
		,{ data: "description" }              //2
...
/**  javascript      vir grid SelectFromGridDialog        (js1Str)
	...
	var columns = [
		{ data: "maintenanceTypeId", name: "MaintenanceTypeId" }           //0 MySql-TableName: MaintenanceType
...
Vir 'n Save Data function                        (js2Str)
	...
	var postData = {
		maintenanceTypeId : $("#xxxMaintenanceTypeId").val()        //0 MySql-TableName: MaintenanceType
		,name : $("#xxxName").val()                                                  //1
...
Vir 'n Populate Data function                                                  (js3Str)
		...
		//  MySql-TableName: MaintenanceType										   (js3Str)
		$("#xxxMaintenanceTypeId").val(data.maintenanceTypeId);           //0
...
/**  HTML  om 'n grid te populate
												<th>MaintenanceTypeId</th>           <!--0  MySql-TableName: MaintenanceType-->
												<th>Name</th>                        <!--1  Name-->
