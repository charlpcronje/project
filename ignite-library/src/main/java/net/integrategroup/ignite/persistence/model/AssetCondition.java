...
/** ******* ********* ** 2023-10-26 19:43:04 ******** *xxx* **/

@Entity
@Table(schema = "ig_db", name = "AssetCondition")
public class AssetCondition implements Serializable {


    private static final long serialVersionUID = 804193375370280034L; /** ID was Generated by Johannes **/
...
/**  javascript      vir grid population        (jsStr)
	...
	var columnsArray = [
		 { data: "assetConditionId" }         //0 MySql-TableName: AssetCondition
		,{ data: "name" }                     //1
		,{ data: "description" }              //2
...
/**  javascript      vir grid SelectFromGridDialog        (js1Str)
	...
	var columns = [
		{ data: "assetConditionId", name: "AssetConditionId" }             //0 MySql-TableName: AssetCondition
...
Vir 'n Save Data function                        (js2Str)
	...
	var postData = {
		assetConditionId : $("#xxxAssetConditionId").val()         //0 MySql-TableName: AssetCondition
		,name : $("#xxxName").val()                                                  //1
...
Vir 'n Populate Data function                                                  (js3Str)
		...
		//  MySql-TableName: AssetCondition										   (js3Str)
		$("#xxxAssetConditionId").val(data.assetConditionId);             //0
...
/**  HTML  om 'n grid te populate
												<th>AssetConditionId</th>            <!--0  MySql-TableName: AssetCondition-->
												<th>Name</th>                        <!--1  Name-->
