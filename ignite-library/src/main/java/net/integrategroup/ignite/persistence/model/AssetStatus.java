...
/** ******* ********* ** 2023-10-26 19:46:34 ******** *xxx* **/

@Entity
@Table(schema = "ig_db", name = "AssetStatus")
public class AssetStatus implements Serializable {


    private static final long serialVersionUID = 617607895321393876L; /** ID was Generated by Johannes **/
...
/**  javascript      vir grid population        (jsStr)
	...
	var columnsArray = [
		 { data: "assetStatusId" }            //0 MySql-TableName: AssetStatus
		,{ data: "name" }                     //1
		,{ data: "description" }              //2
...
/**  javascript      vir grid SelectFromGridDialog        (js1Str)
	...
	var columns = [
		{ data: "assetStatusId", name: "AssetStatusId" }                   //0 MySql-TableName: AssetStatus
...
Vir 'n Save Data function                        (js2Str)
	...
	var postData = {
		assetStatusId : $("#xxxAssetStatusId").val()            //0 MySql-TableName: AssetStatus
		,name : $("#xxxName").val()                                                  //1
...
Vir 'n Populate Data function                                                  (js3Str)
		...
		//  MySql-TableName: AssetStatus										   (js3Str)
		$("#xxxAssetStatusId").val(data.assetStatusId);                   //0
...
/**  HTML  om 'n grid te populate
												<th>AssetStatusId</th>               <!--0  MySql-TableName: AssetStatus-->
												<th>Name</th>                        <!--1  Name-->
